...
public class Background {
	...
	private static final int FLOOR_THICKNESS = 80;
	...
	public Background()
	{
		...
		backgroundRect.set(0,0, (int)SCREEN_WIDTH + 200, (int)SCREEN_HEIGHT);
	}

	protected void draw(Canvas canvas)
	{
		canvas.drawRect(backgroundRect, backgroundPaint);
		canvas.drawLine(0, SCREEN_HEIGHT, SCREEN_WIDTH + 200, SCREEN_HEIGHT, floorPaint);
